      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 96.0, middle: 0.1952),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: -5.3, end: -5.2),
                  Pin(start: -10.7, end: -30.9),
                  child:
          ...
          Pinned.fromPins(
            Pin(size: 89.0, middle: 0.2773),
            Pin(size: 119.3, middle: 0.5838),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 107.0, middle: 0.7196),
            Pin(size: 118.8, middle: 0.5856),
            child:
            // Adobe XD layer: 'プレイ済' (group)
            Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 35.0, middle: 0.5009),
                  Pin(size: 35.0, start: 0.0),
                  child:
